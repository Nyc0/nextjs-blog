...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), '/data/mdy.json');
...
export default function Md3(props) {
  ...
  const optionPrefix = {"PAINT": "P-", "WHEELS" : "W-", "INTERIOR" : "I-", "PREMIUM_PACKAGE": "I-"}
  var nbr = 0;
  var nbrOpt = 0;
  var price = 0;
  ...
  useEffect(() => {
      var ctx = document.getElementById('mdyChart').getContext('2d');
      ...
      for(let n = 0; n < options.length && n < 6; n ++) {
        var ctx = document.getElementById('mdyChartTRIM'+n).getContext('2d');
        md3Chart.push(new ChartJS(ctx, {
          type: 'line',
          data: options[n],
      ...
      for (let n = md3Chart.length - 1; n < 6; n++) {
        document.getElementById("mdyChartTRIM"+n).remove();
      ...
      <Layout>
          ...
          <article>
              ...
              <div className={utilStyles.lightText}>
                  ...
                  <canvas id='mdyChartTRIM1'></canvas>
                  <div className={utilStyles.button}>
                  ...
                  <canvas id='mdyChartTRIM2'></canvas>
                  <div className={utilStyles.button}>
                  ...
                  <canvas id='mdyChartTRIM3'></canvas>
                  <div className={utilStyles.button}>
                  ...
                  <canvas id='mdyChartTRIM4'></canvas>
                  <div className={utilStyles.button}>
                  ...
                  <canvas id='mdyChartTRIM5'></canvas>
                  <div className={utilStyles.button}>
